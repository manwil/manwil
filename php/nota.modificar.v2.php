<?php
	...
	if( isset($_POST['id_nota']) ) {
		...
		mysqli_query($link,"UPDATE nota SET cliente = '".$cli."', empresa = '".$emp."', autorizado = '".$a."', vendedor ='".$ven."', fecha_creacion = '".$fec."', monto = '".$mon."', baja = '".$baj."', tc = '".$tc."', deposito = '".$dep."', forma_pago = '".$fp."', id_cliente = '".$id_cl."', id_usuario = '".$id_us."', id_empleado = '".$id_em."', id_nota_papel = '".$npapel."' WHERE id_nota = '".$id."'");
