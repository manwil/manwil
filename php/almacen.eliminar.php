<?php
	...
	if( isset($_POST['id_almacen']) ) {
		...
		mysqli_query($link,"DELETE FROM almacen WHERE id_almacen='".$_POST['id_almacen']."'");

	
		//seleccionar registro de almacen
		$sql2 = "SELECT * FROM almacen WHERE fecha = '".$fecha."' AND id_usuario ='".$id_usuario."'ORDER BY id_almacen desc";
